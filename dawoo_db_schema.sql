...
-- ============================================
-- 32. 현장 유입경로·공종 미확인 (025_sites_inflow_work_kind_unconfirmed.sql)
-- ============================================
-- NULL 허용 유지. DEFAULT '미확인'. NULL만 백필. 기존 값은 추정하지 않음. NOT NULL/DROP/RLS 없음.
