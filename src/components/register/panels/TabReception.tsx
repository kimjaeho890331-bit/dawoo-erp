  ...
  return (
    <div className="relative pl-10">
      ...
      <div className="relative pb-8">
        ...
        {isPublicWater && (
          <div className="mt-3 space-y-3">
            ...
            <label data-ready-anchor="smsConsent" className="flex items-center gap-2 cursor-pointer">
              <input
                type="checkbox"
      ...
      <div className="relative pb-4">
        ...
        <div className="grid grid-cols-2 gap-3" data-ready-anchor="applicationDate">
